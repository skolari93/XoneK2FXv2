...
class MixerComponent(MixerComponentBase):
    ...
    def __init__(self, session_ring=None, target_track=None, channel_strip_component_type=ChannelStripComponent, *a, **k):
        super().__init__(session_ring=session_ring, target_track=target_track, channel_strip_component_type=channel_strip_component_type, *a, **k)
        self.name = 'FXMixer'
